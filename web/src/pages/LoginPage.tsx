...
export const LoginPage: React.FC<LoginPageProps> = ({
  ...
  return (
    <div className="ytm-login-page-container">
      <div className="ytm-login-card">
        {/* Brand Header */}
        ...
        {user.isLoggedIn ? (
          <div className="ytm-profile-view">
            ...
            <div style={{ margin: '24px 0 0', display: 'flex', gap: '12px', justifyContent: 'center' }}>
              <button className="ytm-btn-pill-action" onClick={onNavigateHome}>
                Go to Music Feed
              </button>
              <button className="ytm-btn-logout" onClick={onLogout}>
                Sign Out
              </button>
            </div>
          </div>
        ) : (
          /* 1-Click Google Login View */
          <div className="ytm-login-body">
            <h1 className="ytm-login-title">Sign in to ISAI Music</h1>
            ...
            <div className="ytm-login-options">
              ...
              <p style={{ fontSize: '12px', color: '#888', marginTop: '16px', textAlign: 'center' }}>
                No details form required. You can edit your username in settings anytime!
              </p>
            </div>
          </div>
        )}
