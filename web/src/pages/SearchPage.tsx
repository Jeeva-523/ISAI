...
const SEARCH_GENRES: Genre[] = [
  {
    id: 'g1',
    name: 'Melody & Romance',
    query: 'Tamil feel good melody hit songs',
  ...
  },
  {
    id: 'g2',
    name: 'Mass & Kuthu',
    query: 'Tamil party kuthu mass songs',
  ...
  },
  {
    id: 'g3',
    name: 'Love Hits',
    query: 'Tamil love romantic hit songs',
  ...
  },
  {
    id: 'g4',
    name: 'Workout Beats',
    query: 'Tamil energetic gym workout bgm beats',
  ...
  },
  {
    ...
    query: 'Tamil god devotional songs',
  ...
  },
  {
    id: 'g7',
    name: 'Sad & Emotional',
    query: 'Tamil sad heartbreak songs',
  ...
  },
  {
    id: 'g8',
    name: 'Retro & 90s Hits',
    query: '90s Tamil hit songs Ilaiyaraaja AR Rahman',
...
export const SearchPage: React.FC<SearchPageProps> = ({
  ...
  return (
    <div style={{ maxWidth: '1300px', margin: '0 auto', paddingBottom: '8px' }}>
      {/* 1. When Empty Query: Render Genre/Mood Grid Tiles */}
      {!searchQuery ? (
        <div>
        ...
        <div style={{ textAlign: 'center', padding: '60px 20px', color: 'var(--text-muted)' }}>
          ...
          <p style={{ fontSize: '14px', marginTop: '4px' }}>
            Try searching for song titles, artist names, or movie names.
          </p>
        </div>
      ) : (
        <div>
